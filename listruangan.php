               ...
               <div class='row'>
                  <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12" id="coltb">
                     <a class="btn btn-sm btn-info" id="btn_tambah"
                        href="<?php echo "ruangan_form.php?md=ad";?>">Tambah</a>
                     <!-- <input type="button" class="btn btn-info" style="" onclick ="validasi_akses()" name="btntambah" id="btntambah" value="Tambah" /> -->

                  </div>
                  <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 text-right" style="text-align:right" id="coltb">
                     <h5>Data Ruangan</h5>
...
function load_data(keyword, page) {
   $.ajax({
      method: "POST",
      // url: "ruangan_listdata.php?jns=add&ub=<?php //echo $akses_ubah; ?>&del=<?php //echo $akses_hapus; ?>&ct=<?php //echo $akses_cetak; ?>&uid=<?php //echo $erp_user_id; ?>&mn=<?php //echo $menu_id;?>",
      url: "ruangan_listdata.php?jns=add",
		data: {
